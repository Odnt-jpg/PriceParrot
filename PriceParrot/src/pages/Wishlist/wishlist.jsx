      ...
      <div className="wishlist-page">
        ...
        <div className="mb-4">
          <button
            ...
            className={`px-4 py-2 rounded bg-green-600 text-white font-semibold hover:bg-green-700 transition ${selected.length === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
          ...
          <div className="wishlist-list space-y-6 px-4">
            {wishlist.map((item) => {
              ...
              return (
                <div
                  key={itemId}
                  className="flex flex-row justify-between items-start border border-gray-200 rounded-xl p-6 bg-white shadow-md hover:shadow-lg transition duration-200"
                >
                  {/* LEFT: Checkbox & Image */}
                  <div className="flex flex-col items-center w-1/6 min-w-[110px]">
                    <input
                      type="checkbox"
                  ...
                  {/* // Name & Buttons // */}
                  <div className="flex flex-col justify-between w-2/5 min-w-[200px]">
                  ...
                  <div className="w-2/5 min-w-[220px] flex flex-col items-end">
                    <div className="text-gray-700 font-medium mb-3">Top 3 Competitor Prices</div>
